  ...
  <section class="flex flex-col bg-[#f3f7f8]">
    <div class="text-center justify-center max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:pt-28">
      <div class="mr-auto place-self-center lg:col-span-7">
        <h1
          class="max-w-2xl text-black mb-4 text-4xl font-semibold leading-none tracking-tight md:text-5xl xl:text-4xl"
        >
        ...
        <div class="space-y-3">
          ...
          <a
            href="#"
            class="inline-flex bg-[#5DADE2] items-center justify-center w-full px-10 py-3 mb-2 mr-2 text-sm font-medium text-gray-900 text-white border border-gray-200 rounded-lg sm:w-auto focus:outline-none hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200"
          >
