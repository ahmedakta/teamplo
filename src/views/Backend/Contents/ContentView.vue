  ...
  <MainLayout>
    <section >
      <div class="container mx-auto px-4">
          <!-- Form Section -->
          <div class="col-span-12 md:col-span-7 lg:col-span-7 xl:col-span-7 rounded-xl mt-10 p-5 md:p-20 bg-white">
            <form
                @submit.prevent="generalStore.makeRequest('api/content/save', data, 'POST', '/projects')"
            >
                  <!-- Side by side inputs -->
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label for="phone" class="block text-sm font-medium text-gray-700">Content Title</label>
                        <input type="text" id="phone" 
                                v-model="data.content_title"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#3AA9D0] text-black focus:border-[#3AA9D0]  sm:text-sm" placeholder="Full Name">
                    </div>
                      <div>
                          <label for="email" class="block text-sm font-medium text-gray-700">Content Slug</label>
                          <input type="text" id="email" v-model="data.slug" name="email" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#3AA9D0] text-black focus:border-[#3AA9D0] sm:text-sm" placeholder="slug-example" disabled>
                      </div>
                      <div>
                          <label for="email" class="block text-sm font-medium text-gray-700">Content Keywords</label>
                      ...
                      <div>
                          <label for="email" class="block text-sm font-medium text-gray-700">Content Category</label>
                          <select name="" id=""
                  ...
                  <div class="mb-6">
                      ...
                      <Editor v-model="data.content_body" editorStyle="height: 320px" class="mt-1 block w-full  rounded-md shadow-sm focus:outline-none focus:ring-[#3AA9D0] text-black focus:border-[#3AA9D0] sm:text-sm"/>
                  </div>
                  <!-- Full-width input -->
                  <div class="mb-6">
