      ...
      >
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <input v-model="data.value.project_name" class="border w-1/2 border-gray-300 rounded-md py-2 pl-3 pr-4 focus:outline-none focus:border-blue-500">
          </div>
          <div>
        ...
        <div class="float-right ">
            <button class="text-white  bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-10 py-3 mr-2  dark:bg-gray-600 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Cancel</button>
            <button class="text-white  bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-3  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" @click="generalStore.makeRequest('api/project/save', data, 'POST')">Save</button>
        </div>
</div>
</div>
  </MainLayout>
