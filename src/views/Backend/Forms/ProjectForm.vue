  ...
  <MainLayout>
    <div class="mx-auto p-4">
      <div
        ...
        <form @submit.prevent="generalStore.makeRequest('api/project/save', data, 'POST' , '/projects')" class="grid grid-cols-2 gap-4">
            <div>
            ...
            <div>
                ...
                >
                <option    
                    v-for="(stage, key) in generalStore.data.stages"
                    :key="key"
                    :value="stage.id" >{{stage.category_name}}</option>
                </select>
            </div>
            <div>
                <h3 class="text-l font-semibold">Status</h3>
...
onMounted(async () => {
  try {
    generalStore.getData('api/projects/create')
