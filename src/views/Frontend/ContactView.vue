    ...
    <section class="py-32">
      <div class="container mx-auto px-4">
        ...
        <div class="text-center text-gray-500 p-2">
          <h2 class="text-2xl text-center mb-8 text-black font-semibold"><span class="text-[#3AA9D0]  font-semibold">Get
              in Touch
            </span>With Us
          </h2>
          <p>
            We're here to help! Whether you have questions, feedback, or need support, feel free to reach out to us
            anytime. Your success is our priority!
          </p>
        </div>
        ...
        <div class="mt-10 grid grid-cols-1 md:grid-cols-12">
          <!-- Information Section -->
          <div
            class="relative col-span-12 md:col-span-5 lg:col-span-5 xl:col-span-5 justify-center bg-[#3AA9D0] text-white p-5 md:p-20 order-2 md:order-1">
            ...
            <div class="p-6 rounded-lg relative">
              <div class="flex py-5 items-center space-x-4">
                <img src="../../assets/contact-email.svg" class="rounded-3xl px-5 py-5 text-white bg-[#48afd4]"
                  alt="" />
                <div>
                  <h2 class="text-lg font-bold">Email Us</h2>
                  <p class="text-white-600">teamplocom@gmail.com</p>
                </div>
              </div>
              <div class="flex py-5 items-center space-x-4">
                <img src="../../assets/contact-phone.svg" class="rounded-3xl px-5 py-5 text-white bg-[#48afd4]"
                  alt="" />
                <div>
              ...
              <div class="flex py-5 items-center space-x-4">
                ...
                <div>
                  <h2 class="text-lg font-bold">Turkey / Istanbul</h2>
                </div>
              </div>
            </div>
            <!-- Social Media Links -->
              ...
              <div class="flex justify-start space-x-4 py-4">
                <a href="">
                  <font-awesome-icon :icon="['fab', 'facebook-f']"
                    class="text-white hover:bg-white hover:text-[#48afd4] text-2xl bg-[#48afd4] py-4 px-4 rounded-lg" />
                </a>
                <a href="">
                ...
                <a href="https://instagram.com/teamplocom" target="_blank">
          ...
          <!-- Form Section -->
          <div class="col-span-12 md:col-span-7 lg:col-span-7 xl:col-span-7 p-5 md:p-20 bg-white order-1 md:order-2">
            <form>
              <!-- Side by side inputs -->
