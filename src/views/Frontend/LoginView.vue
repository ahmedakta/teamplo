    ...
    <div class="bg-white border-[1px] border-gray-200 max-w-md p-10 rounded-xl w-full space-y-8">
      <div>
        ...
        <p class="mt-2 text-center text-sm text-gray-600">
          Or 
          <a href="#" class="font-medium text-blue-500 hover:text-indigo-500">start your 14-day free trial</a>
        </p>
      </div>
      <form @submit.prevent="login" class="mt-8 space-y-6">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            <input id="remember-me" name="remember-me" type="checkbox" class="h-4 w-4 text-blue-500 focus:ring-blue-400 border-gray-300 rounded">
            <label for="remember-me" class="ml-2 block text-sm text-gray-900">Remember me</label>
          </div>

          <div class="text-sm">
            <a href="#" class="font-medium text-blue-500 hover:text-indigo-500">Forgot your password?</a>
          </div>
        </div>

        <div>
          <button @click="($event) => (generalStore.isLoading = true)" type="submit" class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#5dade2] hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400">
        ...
        <div>
          <button type="button" class="group relative w-full flex justify-center py-2 px-4  border-[1px] border-gray-200 text-sm font-medium rounded-md text-black  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400">
            <span class="absolute left-0 inset-y-0 flex items-center pl-3">
